    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVPU_ADD_MARSHAL("keyBits", sizeof(src->algorithm), &src->algorithm, yaml_internal_TPMU_SYM_KEY_BITS_scalar_marshal, sizeof(src->keyBits), &src->keyBits, yaml_internal_TPMU_SYM_KEY_BITS_marshal),
        KVPU_ADD_MARSHAL("mode", sizeof(src->algorithm), &src->algorithm, yaml_internal_TPMU_SYM_MODE_scalar_marshal, sizeof(src->mode), &src->mode, yaml_internal_TPMU_SYM_MODE_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_SYM_DEF_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVPU_ADD_UNMARSHAL("keyBits", sizeof(tmp_dest.algorithm), &tmp_dest.algorithm, yaml_internal_TPMU_SYM_KEY_BITS_scalar_unmarshal, sizeof(tmp_dest.keyBits), &tmp_dest.keyBits, yaml_internal_TPMU_SYM_KEY_BITS_unmarshal),
        KVPU_ADD_UNMARSHAL("mode", sizeof(tmp_dest.algorithm), &tmp_dest.algorithm, yaml_internal_TPMU_SYM_MODE_scalar_unmarshal, sizeof(tmp_dest.mode), &tmp_dest.mode, yaml_internal_TPMU_SYM_MODE_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVPU_ADD_MARSHAL("details", sizeof(src->scheme), &src->scheme, yaml_internal_TPMU_SCHEME_KEYEDHASH_scalar_marshal, sizeof(src->details), &src->details, yaml_internal_TPMU_SCHEME_KEYEDHASH_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_KEYEDHASH_SCHEME_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVPU_ADD_UNMARSHAL("details", sizeof(tmp_dest.scheme), &tmp_dest.scheme, yaml_internal_TPMU_SCHEME_KEYEDHASH_scalar_unmarshal, sizeof(tmp_dest.details), &tmp_dest.details, yaml_internal_TPMU_SCHEME_KEYEDHASH_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVPU_ADD_MARSHAL("details", sizeof(src->scheme), &src->scheme, yaml_internal_TPMU_SIG_SCHEME_scalar_marshal, sizeof(src->details), &src->details, yaml_internal_TPMU_SIG_SCHEME_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_SIG_SCHEME_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVPU_ADD_UNMARSHAL("details", sizeof(tmp_dest.scheme), &tmp_dest.scheme, yaml_internal_TPMU_SIG_SCHEME_scalar_unmarshal, sizeof(tmp_dest.details), &tmp_dest.details, yaml_internal_TPMU_SIG_SCHEME_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVPU_ADD_MARSHAL("details", sizeof(src->scheme), &src->scheme, yaml_internal_TPMU_KDF_SCHEME_scalar_marshal, sizeof(src->details), &src->details, yaml_internal_TPMU_KDF_SCHEME_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_KDF_SCHEME_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVPU_ADD_UNMARSHAL("details", sizeof(tmp_dest.scheme), &tmp_dest.scheme, yaml_internal_TPMU_KDF_SCHEME_scalar_unmarshal, sizeof(tmp_dest.details), &tmp_dest.details, yaml_internal_TPMU_KDF_SCHEME_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVPU_ADD_MARSHAL("details", sizeof(src->scheme), &src->scheme, yaml_internal_TPMU_ASYM_SCHEME_scalar_marshal, sizeof(src->details), &src->details, yaml_internal_TPMU_ASYM_SCHEME_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_ASYM_SCHEME_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVPU_ADD_UNMARSHAL("details", sizeof(tmp_dest.scheme), &tmp_dest.scheme, yaml_internal_TPMU_ASYM_SCHEME_scalar_unmarshal, sizeof(tmp_dest.details), &tmp_dest.details, yaml_internal_TPMU_ASYM_SCHEME_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVPU_ADD_MARSHAL("signature", sizeof(src->sigAlg), &src->sigAlg, yaml_internal_TPMU_SIGNATURE_scalar_marshal, sizeof(src->signature), &src->signature, yaml_internal_TPMU_SIGNATURE_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_SIGNATURE_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVPU_ADD_UNMARSHAL("signature", sizeof(tmp_dest.sigAlg), &tmp_dest.sigAlg, yaml_internal_TPMU_SIGNATURE_scalar_unmarshal, sizeof(tmp_dest.signature), &tmp_dest.signature, yaml_internal_TPMU_SIGNATURE_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVPU_ADD_MARSHAL("parameters", sizeof(src->type), &src->type, yaml_internal_TPMU_PUBLIC_PARMS_scalar_marshal, sizeof(src->parameters), &src->parameters, yaml_internal_TPMU_PUBLIC_PARMS_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_PUBLIC_PARMS_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVPU_ADD_UNMARSHAL("parameters", sizeof(tmp_dest.type), &tmp_dest.type, yaml_internal_TPMU_PUBLIC_PARMS_scalar_unmarshal, sizeof(tmp_dest.parameters), &tmp_dest.parameters, yaml_internal_TPMU_PUBLIC_PARMS_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        ...
        KVPU_ADD_MARSHAL("parameters", sizeof(src->type), &src->type, yaml_internal_TPMU_PUBLIC_PARMS_scalar_marshal, sizeof(src->parameters), &src->parameters, yaml_internal_TPMU_PUBLIC_PARMS_marshal),
        KVPU_ADD_MARSHAL("unique", sizeof(src->type), &src->type, yaml_internal_TPMU_PUBLIC_ID_scalar_marshal, sizeof(src->unique), &src->unique, yaml_internal_TPMU_PUBLIC_ID_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_PUBLIC_Unmarshal(
    ...
    key_value parsed_data[] = {
        ...
        KVPU_ADD_UNMARSHAL("parameters", sizeof(tmp_dest.type), &tmp_dest.type, yaml_internal_TPMU_PUBLIC_PARMS_scalar_unmarshal, sizeof(tmp_dest.parameters), &tmp_dest.parameters, yaml_internal_TPMU_PUBLIC_PARMS_unmarshal),
        KVPU_ADD_UNMARSHAL("unique", sizeof(tmp_dest.type), &tmp_dest.type, yaml_internal_TPMU_PUBLIC_ID_scalar_unmarshal, sizeof(tmp_dest.unique), &tmp_dest.unique, yaml_internal_TPMU_PUBLIC_ID_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        ...
        KVPU_ADD_MARSHAL("sensitive", sizeof(src->sensitiveType), &src->sensitiveType, yaml_internal_TPMU_SENSITIVE_COMPOSITE_scalar_marshal, sizeof(src->sensitive), &src->sensitive, yaml_internal_TPMU_SENSITIVE_COMPOSITE_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMT_SENSITIVE_Unmarshal(
    ...
    key_value parsed_data[] = {
        ...
        KVPU_ADD_UNMARSHAL("sensitive", sizeof(tmp_dest.sensitiveType), &tmp_dest.sensitiveType, yaml_internal_TPMU_SENSITIVE_COMPOSITE_scalar_unmarshal, sizeof(tmp_dest.sensitive), &tmp_dest.sensitive, yaml_internal_TPMU_SENSITIVE_COMPOSITE_unmarshal)
    };
