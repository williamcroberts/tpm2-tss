    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("empty", sizeof(src->empty), &src->empty, yaml_internal_UINT8_marshal)
    };
...
Tss2_MU_YAML_TPMS_EMPTY_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("empty", sizeof(tmp_dest.empty), &tmp_dest.empty, yaml_internal_UINT8_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("sizeofSelect", sizeof(src->sizeofSelect), &src->sizeofSelect, yaml_internal_UINT8_marshal),
        KVP_ADD_MARSHAL("pcrSelect", sizeof(src->pcrSelect), &src->pcrSelect, yaml_internal_BYTE_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_PCR_SELECT_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("sizeofSelect", sizeof(tmp_dest.sizeofSelect), &tmp_dest.sizeofSelect, yaml_internal_UINT8_unmarshal),
        KVP_ADD_UNMARSHAL("pcrSelect", sizeof(tmp_dest.pcrSelect), &tmp_dest.pcrSelect, yaml_internal_BYTE_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("hash", sizeof(src->hash), &src->hash, yaml_internal_TPM2_ALG_ID_marshal),
        KVP_ADD_MARSHAL("sizeofSelect", sizeof(src->sizeofSelect), &src->sizeofSelect, yaml_internal_UINT8_marshal),
        KVP_ADD_MARSHAL("pcrSelect", sizeof(src->pcrSelect), &src->pcrSelect, yaml_internal_BYTE_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
...
Tss2_MU_YAML_TPMS_PCR_SELECTION_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("hash", sizeof(tmp_dest.hash), &tmp_dest.hash, yaml_internal_TPM2_ALG_ID_unmarshal),
        KVP_ADD_UNMARSHAL("sizeofSelect", sizeof(tmp_dest.sizeofSelect), &tmp_dest.sizeofSelect, yaml_internal_UINT8_unmarshal),
        KVP_ADD_UNMARSHAL("pcrSelect", sizeof(tmp_dest.pcrSelect), &tmp_dest.pcrSelect, yaml_internal_BYTE_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("alg", sizeof(src->alg), &src->alg, yaml_internal_TPM2_ALG_ID_marshal),
        KVP_ADD_MARSHAL("algProperties", sizeof(src->algProperties), &src->algProperties, yaml_internal_TPMA_ALGORITHM_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_ALG_PROPERTY_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("alg", sizeof(tmp_dest.alg), &tmp_dest.alg, yaml_internal_TPM2_ALG_ID_unmarshal),
        KVP_ADD_UNMARSHAL("algProperties", sizeof(tmp_dest.algProperties), &tmp_dest.algProperties, yaml_internal_TPMA_ALGORITHM_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("property", sizeof(src->property), &src->property, yaml_internal_TPM2_PT_marshal),
        KVP_ADD_MARSHAL("value", sizeof(src->value), &src->value, yaml_internal_UINT32_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_TAGGED_PROPERTY_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("property", sizeof(tmp_dest.property), &tmp_dest.property, yaml_internal_TPM2_PT_unmarshal),
        KVP_ADD_UNMARSHAL("value", sizeof(tmp_dest.value), &tmp_dest.value, yaml_internal_UINT32_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("tag", sizeof(src->tag), &src->tag, yaml_internal_TPM2_PT_PCR_marshal),
        KVP_ADD_MARSHAL("sizeofSelect", sizeof(src->sizeofSelect), &src->sizeofSelect, yaml_internal_UINT8_marshal),
        KVP_ADD_MARSHAL("pcrSelect", sizeof(src->pcrSelect), &src->pcrSelect, yaml_internal_BYTE_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
...
Tss2_MU_YAML_TPMS_TAGGED_PCR_SELECT_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("tag", sizeof(tmp_dest.tag), &tmp_dest.tag, yaml_internal_TPM2_PT_PCR_unmarshal),
        KVP_ADD_UNMARSHAL("sizeofSelect", sizeof(tmp_dest.sizeofSelect), &tmp_dest.sizeofSelect, yaml_internal_UINT8_unmarshal),
        KVP_ADD_UNMARSHAL("pcrSelect", sizeof(tmp_dest.pcrSelect), &tmp_dest.pcrSelect, yaml_internal_BYTE_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("handle", sizeof(src->handle), &src->handle, yaml_internal_TPM2_HANDLE_marshal),
...
Tss2_MU_YAML_TPMS_TAGGED_POLICY_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("handle", sizeof(tmp_dest.handle), &tmp_dest.handle, yaml_internal_TPM2_HANDLE_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("handle", sizeof(src->handle), &src->handle, yaml_internal_TPM2_HANDLE_marshal),
        KVP_ADD_MARSHAL("timeout", sizeof(src->timeout), &src->timeout, yaml_internal_UINT32_marshal),
        KVP_ADD_MARSHAL("attributes", sizeof(src->attributes), &src->attributes, yaml_internal_TPMA_ACT_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_ACT_DATA_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("handle", sizeof(tmp_dest.handle), &tmp_dest.handle, yaml_internal_TPM2_HANDLE_unmarshal),
        KVP_ADD_UNMARSHAL("timeout", sizeof(tmp_dest.timeout), &tmp_dest.timeout, yaml_internal_UINT32_unmarshal),
        KVP_ADD_UNMARSHAL("attributes", sizeof(tmp_dest.attributes), &tmp_dest.attributes, yaml_internal_TPMA_ACT_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("capability", sizeof(src->capability), &src->capability, yaml_internal_TPM2_CAP_marshal),
...
Tss2_MU_YAML_TPMS_CAPABILITY_DATA_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("capability", sizeof(tmp_dest.capability), &tmp_dest.capability, yaml_internal_TPM2_CAP_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("clock", sizeof(src->clock), &src->clock, yaml_internal_UINT64_marshal),
        KVP_ADD_MARSHAL("resetCount", sizeof(src->resetCount), &src->resetCount, yaml_internal_UINT32_marshal),
        KVP_ADD_MARSHAL("restartCount", sizeof(src->restartCount), &src->restartCount, yaml_internal_UINT32_marshal),
        KVP_ADD_MARSHAL("safe", sizeof(src->safe), &src->safe, yaml_internal_TPMI_YES_NO_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_CLOCK_INFO_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("clock", sizeof(tmp_dest.clock), &tmp_dest.clock, yaml_internal_UINT64_unmarshal),
        KVP_ADD_UNMARSHAL("resetCount", sizeof(tmp_dest.resetCount), &tmp_dest.resetCount, yaml_internal_UINT32_unmarshal),
        KVP_ADD_UNMARSHAL("restartCount", sizeof(tmp_dest.restartCount), &tmp_dest.restartCount, yaml_internal_UINT32_unmarshal),
        KVP_ADD_UNMARSHAL("safe", sizeof(tmp_dest.safe), &tmp_dest.safe, yaml_internal_TPMI_YES_NO_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("time", sizeof(src->time), &src->time, yaml_internal_UINT64_marshal),
...
Tss2_MU_YAML_TPMS_TIME_INFO_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("time", sizeof(tmp_dest.time), &tmp_dest.time, yaml_internal_UINT64_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        ...
        KVP_ADD_MARSHAL("firmwareVersion", sizeof(src->firmwareVersion), &src->firmwareVersion, yaml_internal_UINT64_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_TIME_ATTEST_INFO_Unmarshal(
    ...
    key_value parsed_data[] = {
        ...
        KVP_ADD_UNMARSHAL("firmwareVersion", sizeof(tmp_dest.firmwareVersion), &tmp_dest.firmwareVersion, yaml_internal_UINT64_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("auditCounter", sizeof(src->auditCounter), &src->auditCounter, yaml_internal_UINT64_marshal),
        KVP_ADD_MARSHAL("digestAlg", sizeof(src->digestAlg), &src->digestAlg, yaml_internal_TPM2_ALG_ID_marshal),
...
Tss2_MU_YAML_TPMS_COMMAND_AUDIT_INFO_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("auditCounter", sizeof(tmp_dest.auditCounter), &tmp_dest.auditCounter, yaml_internal_UINT64_unmarshal),
        KVP_ADD_UNMARSHAL("digestAlg", sizeof(tmp_dest.digestAlg), &tmp_dest.digestAlg, yaml_internal_TPM2_ALG_ID_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("exclusiveSession", sizeof(src->exclusiveSession), &src->exclusiveSession, yaml_internal_TPMI_YES_NO_marshal),
...
Tss2_MU_YAML_TPMS_SESSION_AUDIT_INFO_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("exclusiveSession", sizeof(tmp_dest.exclusiveSession), &tmp_dest.exclusiveSession, yaml_internal_TPMI_YES_NO_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        ...
        KVP_ADD_MARSHAL("offset", sizeof(src->offset), &src->offset, yaml_internal_UINT16_marshal),
...
Tss2_MU_YAML_TPMS_NV_CERTIFY_INFO_Unmarshal(
    ...
    key_value parsed_data[] = {
        ...
        KVP_ADD_UNMARSHAL("offset", sizeof(tmp_dest.offset), &tmp_dest.offset, yaml_internal_UINT16_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("magic", sizeof(src->magic), &src->magic, yaml_internal_TPM2_GENERATED_marshal),
        KVP_ADD_MARSHAL("type", sizeof(src->type), &src->type, yaml_internal_TPM2_ST_marshal),
...
Tss2_MU_YAML_TPMS_ATTEST_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("magic", sizeof(tmp_dest.magic), &tmp_dest.magic, yaml_internal_TPM2_GENERATED_unmarshal),
        KVP_ADD_UNMARSHAL("type", sizeof(tmp_dest.type), &tmp_dest.type, yaml_internal_TPM2_ST_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("sessionHandle", sizeof(src->sessionHandle), &src->sessionHandle, yaml_internal_TPM2_HANDLE_marshal),
        KVP_ADD_MARSHAL("nonce", sizeof(src->nonce), &src->nonce, yaml_internal_TPM2B_NONCE_marshal),
        KVP_ADD_MARSHAL("sessionAttributes", sizeof(src->sessionAttributes), &src->sessionAttributes, yaml_internal_TPMA_SESSION_marshal),
...
Tss2_MU_YAML_TPMS_AUTH_COMMAND_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("sessionHandle", sizeof(tmp_dest.sessionHandle), &tmp_dest.sessionHandle, yaml_internal_TPM2_HANDLE_unmarshal),
        KVP_ADD_UNMARSHAL("nonce", sizeof(tmp_dest.nonce), &tmp_dest.nonce, yaml_internal_TPM2B_NONCE_unmarshal),
        KVP_ADD_UNMARSHAL("sessionAttributes", sizeof(tmp_dest.sessionAttributes), &tmp_dest.sessionAttributes, yaml_internal_TPMA_SESSION_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("hashAlg", sizeof(src->hashAlg), &src->hashAlg, yaml_internal_TPM2_ALG_ID_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_SCHEME_HASH_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("hashAlg", sizeof(tmp_dest.hashAlg), &tmp_dest.hashAlg, yaml_internal_TPM2_ALG_ID_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("hashAlg", sizeof(src->hashAlg), &src->hashAlg, yaml_internal_TPM2_ALG_ID_marshal),
        KVP_ADD_MARSHAL("count", sizeof(src->count), &src->count, yaml_internal_UINT16_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_SCHEME_ECDAA_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("hashAlg", sizeof(tmp_dest.hashAlg), &tmp_dest.hashAlg, yaml_internal_TPM2_ALG_ID_unmarshal),
        KVP_ADD_UNMARSHAL("count", sizeof(tmp_dest.count), &tmp_dest.count, yaml_internal_UINT16_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("hashAlg", sizeof(src->hashAlg), &src->hashAlg, yaml_internal_TPM2_ALG_ID_marshal),
        KVP_ADD_MARSHAL("kdf", sizeof(src->kdf), &src->kdf, yaml_internal_TPM2_ALG_ID_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_SCHEME_XOR_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("hashAlg", sizeof(tmp_dest.hashAlg), &tmp_dest.hashAlg, yaml_internal_TPM2_ALG_ID_unmarshal),
        KVP_ADD_UNMARSHAL("kdf", sizeof(tmp_dest.kdf), &tmp_dest.kdf, yaml_internal_TPM2_ALG_ID_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("curveID", sizeof(src->curveID), &src->curveID, yaml_internal_TPM2_ECC_CURVE_marshal),
        KVP_ADD_MARSHAL("keySize", sizeof(src->keySize), &src->keySize, yaml_internal_UINT16_marshal),
...
Tss2_MU_YAML_TPMS_ALGORITHM_DETAIL_ECC_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("curveID", sizeof(tmp_dest.curveID), &tmp_dest.curveID, yaml_internal_TPM2_ECC_CURVE_unmarshal),
        KVP_ADD_UNMARSHAL("keySize", sizeof(tmp_dest.keySize), &tmp_dest.keySize, yaml_internal_UINT16_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        ...
        KVP_ADD_MARSHAL("keyBits", sizeof(src->keyBits), &src->keyBits, yaml_internal_TPM2_KEY_BITS_marshal),
        KVP_ADD_MARSHAL("exponent", sizeof(src->exponent), &src->exponent, yaml_internal_UINT32_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_RSA_PARMS_Unmarshal(
    ...
    key_value parsed_data[] = {
        ...
        KVP_ADD_UNMARSHAL("keyBits", sizeof(tmp_dest.keyBits), &tmp_dest.keyBits, yaml_internal_TPM2_KEY_BITS_unmarshal),
        KVP_ADD_UNMARSHAL("exponent", sizeof(tmp_dest.exponent), &tmp_dest.exponent, yaml_internal_UINT32_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("pinCount", sizeof(src->pinCount), &src->pinCount, yaml_internal_UINT32_marshal),
        KVP_ADD_MARSHAL("pinLimit", sizeof(src->pinLimit), &src->pinLimit, yaml_internal_UINT32_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_NV_PIN_COUNTER_PARAMETERS_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("pinCount", sizeof(tmp_dest.pinCount), &tmp_dest.pinCount, yaml_internal_UINT32_unmarshal),
        KVP_ADD_UNMARSHAL("pinLimit", sizeof(tmp_dest.pinLimit), &tmp_dest.pinLimit, yaml_internal_UINT32_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("nvIndex", sizeof(src->nvIndex), &src->nvIndex, yaml_internal_TPM2_HANDLE_marshal),
        KVP_ADD_MARSHAL("nameAlg", sizeof(src->nameAlg), &src->nameAlg, yaml_internal_TPM2_ALG_ID_marshal),
        KVP_ADD_MARSHAL("attributes", sizeof(src->attributes), &src->attributes, yaml_internal_TPMA_NV_marshal),
        KVP_ADD_MARSHAL("authPolicy", sizeof(src->authPolicy), &src->authPolicy, yaml_internal_TPM2B_DIGEST_marshal),
        KVP_ADD_MARSHAL("dataSize", sizeof(src->dataSize), &src->dataSize, yaml_internal_UINT16_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_NV_PUBLIC_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("nvIndex", sizeof(tmp_dest.nvIndex), &tmp_dest.nvIndex, yaml_internal_TPM2_HANDLE_unmarshal),
        KVP_ADD_UNMARSHAL("nameAlg", sizeof(tmp_dest.nameAlg), &tmp_dest.nameAlg, yaml_internal_TPM2_ALG_ID_unmarshal),
        KVP_ADD_UNMARSHAL("attributes", sizeof(tmp_dest.attributes), &tmp_dest.attributes, yaml_internal_TPMA_NV_unmarshal),
        KVP_ADD_UNMARSHAL("authPolicy", sizeof(tmp_dest.authPolicy), &tmp_dest.authPolicy, yaml_internal_TPM2B_DIGEST_unmarshal),
        KVP_ADD_UNMARSHAL("dataSize", sizeof(tmp_dest.dataSize), &tmp_dest.dataSize, yaml_internal_UINT16_unmarshal)
    };
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("sequence", sizeof(src->sequence), &src->sequence, yaml_internal_UINT64_marshal),
        KVP_ADD_MARSHAL("savedHandle", sizeof(src->savedHandle), &src->savedHandle, yaml_internal_TPM2_HANDLE_marshal),
        KVP_ADD_MARSHAL("hierarchy", sizeof(src->hierarchy), &src->hierarchy, yaml_internal_TPM2_HANDLE_marshal),
...
Tss2_MU_YAML_TPMS_CONTEXT_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("sequence", sizeof(tmp_dest.sequence), &tmp_dest.sequence, yaml_internal_UINT64_unmarshal),
        KVP_ADD_UNMARSHAL("savedHandle", sizeof(tmp_dest.savedHandle), &tmp_dest.savedHandle, yaml_internal_TPM2_HANDLE_unmarshal),
        KVP_ADD_UNMARSHAL("hierarchy", sizeof(tmp_dest.hierarchy), &tmp_dest.hierarchy, yaml_internal_TPM2_HANDLE_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("pcrSelect", sizeof(src->pcrSelect), &src->pcrSelect, yaml_internal_TPML_PCR_SELECTION_marshal),
        KVP_ADD_MARSHAL("pcrDigest", sizeof(src->pcrDigest), &src->pcrDigest, yaml_internal_TPM2B_DIGEST_marshal),
        KVP_ADD_MARSHAL("locality", sizeof(src->locality), &src->locality, yaml_internal_TPMA_LOCALITY_marshal),
        KVP_ADD_MARSHAL("parentNameAlg", sizeof(src->parentNameAlg), &src->parentNameAlg, yaml_internal_TPM2_ALG_ID_marshal),
...
Tss2_MU_YAML_TPMS_CREATION_DATA_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("pcrSelect", sizeof(tmp_dest.pcrSelect), &tmp_dest.pcrSelect, yaml_internal_TPML_PCR_SELECTION_unmarshal),
        KVP_ADD_UNMARSHAL("pcrDigest", sizeof(tmp_dest.pcrDigest), &tmp_dest.pcrDigest, yaml_internal_TPM2B_DIGEST_unmarshal),
        KVP_ADD_UNMARSHAL("locality", sizeof(tmp_dest.locality), &tmp_dest.locality, yaml_internal_TPMA_LOCALITY_unmarshal),
        KVP_ADD_UNMARSHAL("parentNameAlg", sizeof(tmp_dest.parentNameAlg), &tmp_dest.parentNameAlg, yaml_internal_TPM2_ALG_ID_unmarshal),
    ...
    char            **output)
{
    ...
    struct key_value kvs[] = {
        KVP_ADD_MARSHAL("tag", sizeof(src->tag), &src->tag, yaml_internal_TPM_AT_marshal),
        KVP_ADD_MARSHAL("data", sizeof(src->data), &src->data, yaml_internal_UINT32_marshal)
    };
    rc = add_kvp_list(&doc, root, kvs, ARRAY_LEN(kvs));
    return_if_error(rc, "Could not add KVPs");
...
Tss2_MU_YAML_TPMS_AC_OUTPUT_Unmarshal(
    ...
    key_value parsed_data[] = {
        KVP_ADD_UNMARSHAL("tag", sizeof(tmp_dest.tag), &tmp_dest.tag, yaml_internal_TPM_AT_unmarshal),
        KVP_ADD_UNMARSHAL("data", sizeof(tmp_dest.data), &tmp_dest.data, yaml_internal_UINT32_unmarshal)
    };
